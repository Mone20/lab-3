...
//                if (controllerPositions == null)
//                    controllerPositions = new com.db.Controller(new com.db.tables.PositionTable(com.db.Database.connection));
                ...
                resultPosition = controllerPositions.selectAll();
                String htmlReq = "";
                for (int i = 0; i < resultPosition.size(); i++) {
                    UniversityPosition pos = (UniversityPosition) resultPosition.get(i);
                    htmlReq += "\n<tr>\n" +
...
//                    int id = Integer.parseInt(req.getParameter("id"));
//                    if (controllerPositions == null)
//                        controllerPositions = new com.db.Controller(new com.db.tables.DegreeTable(com.db.Database.connection));
//
